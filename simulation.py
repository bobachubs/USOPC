...
print(data[(data["Round"]=="qual")]["Apparatus"].unique())
...
# country_women_athletes = women_data.groupby('Country')['FullName'].unique()

# country_medals = dict()
# for country in countries:
#     women_athletes = data[(data["Gender"] == 'w') & (data["Country"] == country)]["FullName"].unique()
#     women_combos = list(combinations(women_athletes, 5))
#     womens_max_medals = 0
#     womens_max_combo = None
#     for womens_combo in women_combos:
#         medal_count = simulate_individual(data, 'w', womens_combo)
#         if medal_count > womens_max_medals:
#             womens_max_medals = medal_count
#             womens_max_combo = womens_combo
#             country_medals[country] = (womens_max_combo, womens_max_medals)

# print(country_medals)

print(simulate_individual(data, 'm', None))
